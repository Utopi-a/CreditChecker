...
import { KamokuSeiseki } from "./components/KamokuSeiseki";
        ...
        {data && (
          <>
            ...
            <KamokuTani
              ...
              needTani={6}
              data={data}
              kamokuNo={/^EB14908|^EB14978|EB14918|EB14928/}
            />
            <KamokuTani
            ...
            <KamokuTani
              ...
              data={data}
              kamokuNo={
                /^3[2-7].....|^99.....|^9200[1-2]..|^9100[12]..|^945[4567].../
              }
            />
            <KamokuTani
              kamoku={
            ...
            <KamokuSeiseki data={data} seiseki={"A"} />
            <KamokuSeiseki data={data} seiseki={"B"} />
            <KamokuSeiseki data={data} seiseki={"C"} />
            <KamokuSeiseki data={data} seiseki={"D"} />
            <KamokuSeiseki data={data} seiseki={"P"} />
            <KamokuSeiseki data={data} seiseki={"F"} />
          </>
        )}
      </Box>
      <Footer />
